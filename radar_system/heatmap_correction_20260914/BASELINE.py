    ...
    def run(self):
        ...
        def depth_callback(msg):
            if self.display_mode != 'depth':
                return
            now = time.time()
            if now - self.last_depth_time < 0.015:
                return
