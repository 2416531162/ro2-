...
class RadarCanvas(QWidget):
    ...
    def paintEvent(self, event):
        ...
        for color, points in zip(['#CA4653', '#A16B12', '#087F83'], groups):
...
class CorsConfigDialog(QDialog):
    def __init__(self, parent=None, ros_thread=None):
        ...
        self.stat_frame.setStyleSheet("background: #FFFFFF; border: 1px solid #DCE5EC; border-radius: 6px; padding: 8px 12px;")
